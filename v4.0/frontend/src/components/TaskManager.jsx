            ...
            {showPopup && 
                <div className='overlay'>
                    <div className='popup'>
                        ...
                        <textarea rows="3" className={errorData?.description ? 'error' : ''} name='description' value={taskData?.description} onChange={(e)=>handleInput(e)}></textarea>
                        ...
                        <input type='date' style={{"height": "35px"}} className={errorData?.deadline ? 'error' : ''} autoComplete='off' name='deadline' value={taskData?.deadline} onChange={(e)=>handleInput(e)} />
